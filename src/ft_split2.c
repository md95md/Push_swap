...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/08/17 16:30:49 by agaleeva          #+#    #+#             */
/*   Updated: 2024/08/23 14:57:25 by agaleeva         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char **ft_split2(char *s, char c) //Define a function that returns the substrings in a string seperated by a delimiter
{
